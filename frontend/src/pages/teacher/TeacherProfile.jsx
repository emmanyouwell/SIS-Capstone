...
function TeacherProfile() {
  ...
  useEffect(() => {
    if (user) {
      ...
      const emergencyContact = user.roleData?.emergencyContactName && user.roleData?.emergencyContactNumber
        ? `${user.roleData.emergencyContactName} - ${user.roleData.emergencyContactNumber}`
        : '';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const emergencyContactName = emergencyParts[0] || '';
      const emergencyContactNumber = emergencyParts[1] || '';
      ...
      // Note: Emergency contact update would require a separate endpoint for teacher data
        ...
        <div className={styles.profileHeader}>
          ...
          <div className={styles.profileInfo}>
            ...
            <div className={styles.profileDetails}>
              <h2>{displayName}</h2>
              <p className={styles.role}>{user?.roleData?.position || 'Teacher'}</p>
              <p className={styles.department}>{user?.roleData?.department || 'Department'}</p>
            </div>
          </div>
        </div>
              ...
              <>
                <div className={styles.infoGrid}>
                  ...
                  <div className={styles.infoItem}>
                    ...
                    <p>{formData.emergencyContact || (user?.roleData?.emergencyContactName && user?.roleData?.emergencyContactNumber ? `${user.roleData.emergencyContactName} - ${user.roleData.emergencyContactNumber}` : '')}</p>
                  </div>
                </div>
          ...
          <div className={styles.profileSection}>
            ...
            <div className={styles.infoGrid}>
              ...
              <div className={styles.infoItem}>
                ...
                <p>{user?.roleData?.teachingLoad ? `${user.roleData.teachingLoad} hours/week` : 'N/A'}</p>
              </div>
              <div className={styles.infoItem}>
